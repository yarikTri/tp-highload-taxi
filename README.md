...
![HL_10_4 drawio](https://github.com/yarikTri/tp-highload-taxi/assets/91901091/1b282f9c-f6bd-4b06-9a2e-1d75549b83fd)


## Часть 11. Расчёт ресурсов <a name="11"></a>

- S3:
  - Размещение на bare-metal
  - Прирост хранения: 1.3 ТБ/год (без резервных копий)
  - 1 резервная копия
  - `5 лет * 2 реплики * 1.3 ТБ/год / 1 ТБ конфигурации` = 13 серверов
  - Выбранная конфигурация: 1U 2x6430/4x8GB/1xNVMe1TB/2x10Gb/s
  
- БД:
  - Размещение на bare-metal
  - Прирост хранения:
  - 4 реплики - 2 masters, 2 slaves
  - `` = количество серверов
  - Выбранная конфигурация: 1U 2x6430/4x8GB/1xNVMe128Gb/2x10Gb/s

- Сервисы в Kubernetes
  - 100 RPS/CPU по таблице (50 из них внутрення сеть)
  - 
