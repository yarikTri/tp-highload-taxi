...
Проектирование высоконагруженного сервиса заставляет нас идти на некоторые издержки и компромиссы ради оптимизации работы базы данных при её масштабировании.
...
![logic_scheme](https://github.com/yarikTri/tp-highload-taxi/assets/91901091/dd4d603c-51e3-49ad-badb-06532dec4de4)
